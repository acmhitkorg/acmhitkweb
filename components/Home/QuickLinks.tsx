			...
			<div className="max-w-7xl mx-auto">
				<div className="text-center mb-16">
					...
					<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
						Take the next step in your journey with ACM HITK. Connect, learn, and grow
						with us.
					</p>
				</div>
					...
					{[
						{
							...
							description:
								'Join our vibrant community and unlock exclusive benefits.',
							href: '/join',
							icon: Users,
						},
						{
					...
					<div className="flex justify-center space-x-4">
						{socialMedia.map((social, index) => (
							<Button
								...
								variant="outline"
								asChild
								className="w-12 h-12 p-0 rounded-full hover:scale-110 transition-transform duration-300"
							>
