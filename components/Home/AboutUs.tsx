					...
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p className="text-lg text-muted-foreground mb-6 leading-relaxed">
								We are the student chapter of the Association for Computing
								Machinery at Heritage Institute of Technology. Our mission is to
								create an inclusive environment where students can explore
								cutting-edge technologies, develop professional skills, and build
								lasting connections in the computing community.
							</p>
							<p className="text-lg text-muted-foreground mb-8 leading-relaxed">
								Through workshops, hackathons, guest lectures, and collaborative
								projects, we empower our members to become innovative leaders in the
