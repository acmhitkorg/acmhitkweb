...
export const pastMembers: TeamMember[] = [
    {
        ...
        roleAtHITK:
            "Assistant Professor, Department of Computer Science and Engineering, HITK",
        currentRole:
            "Assistant Professor, Department of Computer Science and Engineering, HITK",
        image: "/past-members/webp/Reshma-Roychoudhuri.webp",
        bio: `With 6 plus years of experience in IT industry Reshma Roychoudhuri joined Heritage in 2012 to explore her passion  for teaching. She has always been involved in various club activities and responsibilities in school, college, and even in her IT workplace. Being entrusted with ACM started an enriching journey here in Heritage, one that she still cherishes. We ( she and the team then) started the annual flagship event, Brainstorm, in a bid to revive the club registrations. It is heartwarming to see the legacy continue and to witness the growth of the club under different faculty and student members`,
        achievements: `She started the annual flagship event Brainstorm at ACM HITK Student Chapter`,
        socials: [
            {
                name: "Email",
  ...
  Professor (January 2013 - June 2017).`,
        currentRole:
            "Professor, Department of Computer Science and Engineering, HITK",
        image: "/past-members/webp/Dr-Dinabandhu-Bhandari.webp",
  ...
  ACM student chapter at HITK.`,
        currentRole:
            "Associate Professor, School Chair @ School of Mathematical and Computational Sciences, Indian Association for the Cultivation of Science, Kolkata",
        image: "/past-members/webp/Dr-Partha-Basuchowdhuri.webp",
    ...
    },
    {
        ...
        currentRole:
            "Assistant Professor, Department of Computer Science and Engineering, HITK",
        image: "/past-members/webp/Dr-Sabyasachi-Banerjee.webp",
    ...
    },
    {
        ...
        image: "/past-members/webp/Ashmi-Banerjee.webp",
    ...
    },
    {
        ...
        image: "/past-members/webp/Ananya-Majumdar.webp",
    ...
    },
    {
        ...
        roleAtHITK: "CSE'24",
        currentRole:
            "Contributor/Maintainer at the Ethereum Foundation and Ethereum Core Developer at Status",
        image: "/past-members/webp/Agnish-Ghosh.webp",
    ...
    },
    {
        ...
        image: "/past-members/webp/Protyasha-Kundu.webp",
  ...
  3. PGEE AIR 5.`,
    ...
    },
    {
        ...
        image: "/past-members/webp/Swapnil-Aichbhaumik.webp",
