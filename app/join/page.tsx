			...
			<main className="min-h-screen pt-24">
                ...
                Membership Applications Open
							...
							<p className="text-xl text-muted-foreground leading-relaxed mb-8">
								Become part of a vibrant community of computing enthusiasts and
								accelerate your journey in technology.
							</p>
						</div>
					</div>
				</section>
					...
					<div className="max-w-7xl mx-auto">
						<div className="text-center mb-12 animate-in slide-in-from-bottom-10 duration-1000 delay-200">
							...
							<p className="text-lg text-muted-foreground">
								Discover the incredible benefits and opportunities that await you as
								a member.
							</p>
						</div>
								...
								>
									<GlassCard className="p-6 text-center group relative overflow-hidden h-full">
										...
										<div className="relative">
											<div
												className={`w-12 h-12 bg-gradient-to-br ${benefit.color} rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}
											>
									...
									<div className="flex gap-4 justify-center">
										<Button variant="ghost" size="sm" className="group">
											<Link
												...
												href="mailto:acmhitk.studentchapter@gmail.com"
											>
