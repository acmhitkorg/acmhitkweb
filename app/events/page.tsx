				...
				<section className="py-20 px-4 sm:px-6 lg:px-8">
					...
					<div className="max-w-4xl mx-auto text-center">
						...
						<p className="text-xl text-muted-foreground leading-relaxed">
							Join us for exciting workshops, hackathons, seminars, and networking
							events designed to enhance your skills and expand your professional
							network.
						</p>
					</div>
				</section>
								...
								{sortedUpcomingEvents.map((event, index) => (
									...
									>
										...
										<div
											...
											style={{
												backgroundImage:
													"url(\"data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.65' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)' opacity='0.1'/%3E%3C/svg%3E\")",
											}}
										/>
                      ...
                      ${
							...
							<div className="text-center py-12">
								...
								<p className="text-muted-foreground mt-2">
									Check back later for updates on our next events!
								</p>
							</div>
						)}
					</div>
				...
				<section className="py-16 px-4 sm:px-6 lg:px-8 bg-muted/10">
					<div className="max-w-7xl mx-auto">
						<div className="text-center mb-12">
							...
							<p className="text-lg text-muted-foreground">
								Take a look at our successful events and the impact we've made in
								our community.
							</p>
						</div>
				...
				<section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/20">
					<div className="max-w-4xl mx-auto text-center">
						...
						<p className="text-lg text-muted-foreground mb-8">
							Join our community to get notified about upcoming events and exclusive
							opportunities.
						</p>
