						...
						<div className="grid lg:grid-cols-2 gap-8">
							<GlassCard className="p-8">
								...
								<p className="text-muted-foreground leading-relaxed">
									...
									connections within the global computing community. We strive to
							...
							<GlassCard className="p-8">
								...
								<p className="text-muted-foreground leading-relaxed">
									To be the leading student organization that nurtures innovative
									thinking, promotes excellence in computing education, and
									produces future leaders who will drive technological advancement
									and positive change in society. We envision a community where
									every member thrives and contributes meaningfully.
								</p>
							</GlassCard>
						</div>
					</div>
						...
						<GlassCard className="p-8 lg:p-12">
							<div className="text-center mb-12">
								...
								<p className="text-lg text-muted-foreground max-w-3xl mx-auto">
									...
									largest educational and scientific computing society, advancing
					...
					<div className="max-w-7xl mx-auto">
						<div className="text-center mb-12">
							...
							<p className="text-lg text-muted-foreground max-w-3xl mx-auto">
								...
								shaping ACM HITK's journey. Their belief in our mission to foster
								computing excellence continues to inspire us.
							</p>
						</div>
						...
						<div className="bg-gradient-to-br from-blue-500/5 to-teal-500/10 p-8 rounded-2xl backdrop-blur-sm mb-12">
							<p className="text-lg leading-relaxed text-muted-foreground mb-6">
								...
								, for their vision and dedication in establishing the ACM Student
								Chapter at HITK on{' '}
								<span className="font-medium text-foreground">
									18th December 2011
								</span>
							...
							<p className="text-lg leading-relaxed text-muted-foreground">
								...
								for their continuous support and for providing an environment that
								encourages technological innovation and academic excellence.
							</p>
						</div>
				...
				<section className="py-20 px-4 sm:px-6 lg:px-8">
					<div className="max-w-4xl mx-auto text-center">
						...
						<p className="text-lg text-muted-foreground mb-8">
							Take the first step towards an exciting journey of learning, growth, and
							innovation.
						</p>
